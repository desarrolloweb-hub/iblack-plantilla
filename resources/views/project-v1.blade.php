    ...
    <div class="main-page-wrapper dark-bg p-30">
        ...
        <div id="preloader">
            <div id="ctn-preloader" class="ctn-preloader">
                <div class="icon"><img src="{{ URL::asset('assets/images/loader.svg') }}" alt=""
                        class="m-auto d-block"> <span></span></div>
                                ...
                                <ul class="navbar-nav align-items-lg-center">
                                    <li class="d-block d-lg-none">
                                        <div class="logo"><a href="index" class="d-block"><img
                                                    src="{{ URL::asset('assets/images/logo/logo_01.svg') }}"
                                                    alt=""></a></div>
                                    </li>
                                                ...
                                                <div class="row gx-3">
                                                    <div class="col-lg-3">
                                                        <a href="index" class="home-item w-100">
                                                            <div class="img-item"><img
                                                                    src="{{ URL::asset('assets/images/menu/home01.jpg') }}"
                                                                    alt="" class="w-100"></div>
                                                    ...
                                                    <div class="col-lg-3">
                                                        <a href="index-2" class="home-item w-100">
                                                            <div class="img-item"><img
                                                                    src="{{ URL::asset('assets/images/menu/home02.jpg') }}"
                                                                    alt="" class="w-100"></div>
                                                            <span>AI Writer</span>
                                                        </a>
                                                    </div>
                                                    <div class="col-lg-3">
                                                        <a href="index-3" class="home-item w-100">
                                                            <div class="img-item"><img
                                                                    src="{{ URL::asset('assets/images/menu/home03.jpg') }}"
                                                                    alt="" class="w-100"></div>
                                                    ...
                                                    <div class="col-lg-3">
                                                        <a href="index-4" class="home-item w-100">
                                                            <div class="img-item"><img
                                                                    src="{{ URL::asset('assets/images/menu/home04.jpg') }}"
                                                                    alt="" class="w-100"></div>
                                                            <span>CRM</span>
                                                        </a>
                                                    </div>
                                                    <div class="col-lg-3">
                                                        <a href="index-5" class="home-item w-100">
                                                            <div class="img-item"><img
                                                                    src="{{ URL::asset('assets/images/menu/home05.jpg') }}"
                                                                    alt="" class="w-100"></div>
                                                    ...
                                                    <div class="col-lg-3">
                                                        <a href="index-6" class="home-item w-100">
                                                            <div class="img-item"><img
                                                                    src="{{ URL::asset('assets/images/menu/home06.jpg') }}"
                                                                    alt="" class="w-100"></div>
                                                    ...
                                                    <div class="col-lg-3">
                                                        <a href="index-7" class="home-item w-100">
                                                            <div class="img-item"><img
                                                                    src="{{ URL::asset('assets/images/menu/home07.jpg') }}"
                                                                    alt="" class="w-100"></div>
                                                    ...
                                                    <div class="col-lg-3">
                                                        <a href="index-8" class="home-item w-100">
                                                            <div class="img-item"><img
                                                                    src="{{ URL::asset('assets/images/menu/home08.jpg') }}"
                                                                    alt="" class="w-100"></div>
                                                            <span>Help Desk</span>
                                                        </a>
                                                    </div>
                                                    <div class="col-lg-3">
                                                        <a href="index-9" class="home-item w-100">
                                                            <div class="img-item"><img
                                                                    src="{{ URL::asset('assets/images/menu/home09.jpg') }}"
                                                                    alt="" class="w-100"></div>
                                                    ...
                                                    <div class="col-lg-3">
                                                        <a href="index-10" class="home-item w-100">
                                                            <div class="img-item"><img
                                                                    src="{{ URL::asset('assets/images/menu/home10.jpg') }}"
                                                                    alt="" class="w-100"></div>
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="menu-column">
                                                        ...
                                                        <ul class="style-none mega-dropdown-list">
                                                            <li><a href="about-us-v1" class="dropdown-item"><span>About
                                                                        Us-1</span></a></li>
                                                            <li><a href="about-us-v2" class="dropdown-item"><span>About
                                                                        Us-2</span></a></li>
                                                            <li><a href="about-us-v3" class="dropdown-item"><span>About
                                                                        Us-3</span></a></li>
                                                            <li><a href="team-v1"
                                    ...
                                    <li class="nav-item dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a href="blog-v1" class="dropdown-item"><span>Blog Full Width</span></a>
                                            </li>
                                            <li><a href="blog-v2" class="dropdown-item"><span>Blog List</span></a></li>
                                            <li><a href="blog-v3" class="dropdown-item"><span>Blog 2 column</span></a>
                                            </li>
                                            <li><a href="blog-details" class="dropdown-item"><span>Blog Details</span></a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li class="nav-item dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a href="contact-v1" class="dropdown-item"><span>Contact Us-1</span></a>
                                            </li>
                                            <li><a href="contact-v2" class="dropdown-item"><span>Contact Us-2</span></a>
                                            </li>
                                        </ul>
                                    </li>
            ...
            <div id="isotop-gallery-wrapper" class="grid-2column">
                ...
                <div class="isotop-item application brand mb-30">
                    <div class="project-block-two position-relative z-1">
                        <img src="{{ URL::asset('assets/images/media/img_38.jpg') }}" alt=""
                            class="w-100 media-img tran3s">
                        <a href="project-details" class="btn-one rounded-circle"><i class="bi bi-arrow-up-right"></i></a>
                    </div>
                    <!-- /.project-block-two -->
                </div>
                <!-- /.isotop-item -->
                <div class="isotop-item design mb-30">
                    <div class="project-block-two position-relative z-1">
                        <img src="{{ URL::asset('assets/images/media/img_39.jpg') }}" alt=""
                            class="w-100 media-img tran3s">
                        <a href="project-details" class="btn-one rounded-circle"><i class="bi bi-arrow-up-right"></i></a>
                    </div>
                    <!-- /.project-block-two -->
                ...
                <div class="isotop-item market dev mb-30">
                    <div class="project-block-two position-relative z-1">
                        <img src="{{ URL::asset('assets/images/media/img_40.jpg') }}" alt=""
                            class="w-100 media-img tran3s">
                        <a href="project-details" class="btn-one rounded-circle"><i class="bi bi-arrow-up-right"></i></a>
                    </div>
                    <!-- /.project-block-two -->
                ...
                <div class="isotop-item market brand mb-30">
                    <div class="project-block-two position-relative z-1">
                        <img src="{{ URL::asset('assets/images/media/img_41.jpg') }}" alt=""
                            class="w-100 media-img tran3s">
                        <a href="project-details" class="btn-one rounded-circle"><i class="bi bi-arrow-up-right"></i></a>
                    </div>
                    <!-- /.project-block-two -->
                ...
                <div class="isotop-item application dev mb-30">
                    <div class="project-block-two position-relative z-1">
                        <img src="{{ URL::asset('assets/images/media/img_42.jpg') }}" alt=""
                            class="w-100 media-img tran3s">
                        <a href="project-details" class="btn-one rounded-circle"><i class="bi bi-arrow-up-right"></i></a>
                    </div>
                    <!-- /.project-block-two -->
                ...
                <div class="isotop-item design mb-30">
                    <div class="project-block-two position-relative z-1">
                        <img src="{{ URL::asset('assets/images/media/img_43.jpg') }}" alt=""
                            class="w-100 media-img tran3s">
                        <a href="project-details" class="btn-one rounded-circle"><i class="bi bi-arrow-up-right"></i></a>
                    </div>
                    <!-- /.project-block-two -->
        ...
        <!--
              ...
              -->
        <div
            class="fancy-banner-one position-relative z-1 bg-one border-30 text-center pt-130 lg-pt-80 pb-130 lg-pb-80 mb-30 lg-mb-20">
            <div class="container">
                <div class="row">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-6">
                                <form action="#" class="position-relative">
                                    ...
                                    <button class="tran3s"><img src="{{ URL::asset('assets/images/icon/icon_05.svg') }}"
                        ...
                        <div class="row">
                            <div class="col-lg-3">
                                <div class="footer-intro mb-30">
                                    <div class="logo">
                                        <a href="index">
                                            <img src="{{ URL::asset('assets/images/logo/logo_01.1.svg') }}"
                                                alt="">
                                        </a>
                                    </div>
                                    <!-- logo -->
