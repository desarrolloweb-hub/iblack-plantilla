				...
				<div id="isotop-gallery-wrapper" class="grid-2column">
                    ...
                    <div class="isotop-item application brand mt-50 lg-mt-30">
                        <div class="project-block-three position-relative z-1">
                            <img src="{{ URL::asset('assets/images/media/img_44.jpg')}}" alt="" class="w-100 media-img tran3s">
                    ...
                    <div class="isotop-item design mt-50 lg-mt-30">
                        <div class="project-block-three position-relative z-1">
                            <img src="{{ URL::asset('assets/images/media/img_45.jpg')}}" alt="" class="w-100 media-img tran3s">
                            <div class="position-relative d-flex justify-content-between align-items-start pt-35">
                                <div class="pe-3">
                    ...
                    <div class="isotop-item market dev mt-50 lg-mt-30">
                        <div class="project-block-three position-relative z-1">
                            <img src="{{ URL::asset('assets/images/media/img_46.jpg')}}" alt="" class="w-100 media-img tran3s">
                            <div class="position-relative d-flex justify-content-between align-items-start pt-35">
                                <div class="pe-3">
                    ...
                    <div class="isotop-item market brand mt-50 lg-mt-30">
                        <div class="project-block-three position-relative z-1">
                            <img src="{{ URL::asset('assets/images/media/img_47.jpg')}}" alt="" class="w-100 media-img tran3s">
                            <div class="position-relative d-flex justify-content-between align-items-start pt-35">
                                <div class="pe-3">
                    ...
                    <div class="isotop-item application dev mt-50 lg-mt-30">
                        <div class="project-block-three position-relative z-1">
                            <img src="{{ URL::asset('assets/images/media/img_48.jpg')}}" alt="" class="w-100 media-img tran3s">
                            <div class="position-relative d-flex justify-content-between align-items-start pt-35">
                                <div class="pe-3">
                    ...
                    <div class="isotop-item design mt-50 lg-mt-30">
                        <div class="project-block-three position-relative z-1">
                            <img src="{{ URL::asset('assets/images/media/img_49.jpg')}}" alt="" class="w-100 media-img tran3s">
                            <div class="position-relative d-flex justify-content-between align-items-start pt-35">
                                <div class="pe-3">
