...
@section('main')
	<div class="main-page-wrapper dark-bg-two">
        ...
        <div class="contact-section-three position-relative z-1 mt-130 lg-mt-80 pb-180 lg-pb-80">
                    ...
                    <div class="col-lg-5 d-flex">
                        <div class="address-wrapper w-100 ms-xxl-5 mt-10 md-mt-60">
                            <div class="wrapper dark-bg-two w-100 h-100">
                                <ul class="style-none">
                                    <li>
                                        <img src="{{ URL::asset('assets/images/icon/icon_97.svg')}}" alt="">
                                        <h6>Our Address</h6>
                                        <p>1012 Pebda Parkway, Mirpur dhos Dhaka, Bangladesh</p>
                                    </li>
                                    <li>
                                        <img src="{{ URL::asset('assets/images/icon/icon_98.svg')}}" alt="">
                                        <h6>Contact Info</h6>
                                        <p>Open a chat or give us call at <br> <a href="#">(880) 1789456710</a></p>
                                    </li>
                                    <li>
                                        <img src="{{ URL::asset('assets/images/icon/icon_99.svg')}}" alt="">
                                        <h6>Live support</h6>
                ...
                <div class="row gx-xxl-5">
                    <div class="col-lg-6">
                        <div class="card-style-sixteen bg-grey mt-35">
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                <img src="{{ URL::asset('assets/images/icon/icon_100.svg')}}" alt="">
                            </div>
                    ...
                    <div class="col-lg-6">
                        <div class="card-style-sixteen bg-grey mt-35">
                            <div class="d-flex align-items-center justify-content-between">
                                <h6>Community</h6>
                                <img src="{{ URL::asset('assets/images/icon/icon_101.svg')}}" alt="">
                            </div>
            ...
            <img src="{{ URL::asset('assets/images/shape/shape_92.svg')}}" alt="" class="shapes shape_01">
        </div>
        <!-- /.contact-section-three -->
