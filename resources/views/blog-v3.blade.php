                ...
                <div id="isotop-gallery-wrapper" class="grid-2column pt-60 lg-pt-40">
                    ...
                    <div class="isotop-item application life">
                        <article class="blog-meta-one style-two mb-70 lg-mb-40">
                            <div class="media">
                                <img src="{{ URL::asset('assets/images/blog/blog_img_10.jpg')}}" alt="" class="w-100">
                            </div>
                            <div class="post-meta position-relative z-1">
                                ...
                                <div class="d-lg-flex justify-content-between align-items-center">
                                    ...
                                    <a href="blog-details" class="read-more rounded-circle tran3s md-mt-20"><i class="bi bi-arrow-up-right"></i></a>
                                </div>
                            </div>
                            <!-- /.post-meta -->
                        </article>
                    ...
                    <div class="isotop-item application dev other">
                        <article class="blog-meta-one style-two mb-70 lg-mb-40">
                            <div class="media">
                                <img src="{{ URL::asset('assets/images/blog/blog_img_11.jpg')}}" alt="" class="w-100">
                            </div>
                            <div class="post-meta position-relative z-1">
                    ...
                    <div class="isotop-item market design dev other">
                        <article class="blog-meta-one style-two mb-70 lg-mb-40">
                            <div class="media">
                                <img src="{{ URL::asset('assets/images/blog/blog_img_12.jpg')}}" alt="" class="w-100">
                            </div>
                            <div class="post-meta position-relative z-1">
                    ...
                    <div class="isotop-item application">
                        <article class="blog-meta-one style-two mb-70 lg-mb-40">
                            <div class="media">
                                <img src="{{ URL::asset('assets/images/blog/blog_img_13.jpg')}}" alt="" class="w-100">
                            </div>
                            <div class="post-meta position-relative z-1">
                                <div class="date">09 mar, 2024</div>
                    ...
                    <div class="isotop-item market design dev">
                        <article class="blog-meta-one style-two mb-70 lg-mb-40">
                            <div class="media">
                                <img src="{{ URL::asset('assets/images/blog/blog_img_14.jpg')}}" alt="" class="w-100">
                            </div>
                            <div class="post-meta position-relative z-1">
                                <div class="date">13 apr, 2024</div>
                    ...
                    <div class="isotop-item application other">
                        <article class="blog-meta-one style-two mb-70 lg-mb-40">
                            <div class="media">
                                <img src="{{ URL::asset('assets/images/blog/blog_img_15.jpg')}}" alt="" class="w-100">
                            </div>
                            <div class="post-meta position-relative z-1">
                                <div class="date">09 mar, 2024</div>
                                <a href="blog-details" class="blog-title d-block"><h4>Manage your online
                    ...
                    <div class="isotop-item market life">
                        <article class="blog-meta-one style-two mb-70 lg-mb-40">
                            <div class="media">
                                <img src="{{ URL::asset('assets/images/blog/blog_img_16.jpg')}}" alt="" class="w-100">
                            </div>
                            <div class="post-meta position-relative z-1">
                                <div class="date">13 apr, 2024</div>
                                <a href="blog-details" class="blog-title d-block"><h4>Our Travel Card Makes
                                    you Happy.</h4></a>
                                <div class="d-lg-flex justify-content-between align-items-center">
                                    <ul class="style-none tags d-flex flex-wrap">
                                        <li><a href="#">Tips</a></li>
                    ...
                    <div class="isotop-item market design life">
                        <article class="blog-meta-one style-two mb-70 lg-mb-40">
                            <div class="media">
                                <img src="{{ URL::asset('assets/images/blog/blog_img_17.jpg')}}" alt="" class="w-100">
                            </div>
                            <div class="post-meta position-relative z-1">
                                <div class="date">09 mar, 2024</div>
                                <a href="blog-details" class="blog-title d-block"><h4>Manage your online
